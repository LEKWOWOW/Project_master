...
class Company:
    def __init__(self):
        ...
        self.__customers = []
        self.__ticket = []
    def view_ticket(self, customer_id):
        user_tickets = [ticket for ticket in self.__ticket if ticket.booking.customer.user_id == customer_id]
    ...
    def view_customer(self):
        ...
        for i in self.__customers:
           customer_list.append(f"{i.customer_id}, {i.customer_name}, {i.password}")
    ...
    def process_payment(self, customer_id, seat_number):
        print(f"DEBUG: Processing payment for customer_id={customer_id}, seat_number={seat_number}")

        if seat_number is None:
            return None, "❌ ไม่พบหมายเลขที่นั่ง กรุณาเลือกที่นั่งก่อนดำเนินการชำระเงิน"
        ...
        if not booking:
            return None, "❌ ไม่พบการจอง กรุณาจองที่นั่งก่อนชำระเงิน"
